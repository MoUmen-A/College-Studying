...
1. **Defined**  
   *(Ref: [AllContent.txt:295]( /SoftwareEng/Lec/AllContent.txt#L295) - "Defined: Process management procedures and strategies defined and used.")*
2. **system as a whole**  
   *(Ref: [AllContent.txt:512-513]( /SoftwareEng/Lec/AllContent.txt#L512-513) - "Non-functional requirements... often apply to the system as a whole.")*
3. **acceptance**  
   *(Ref: [AllContent.txt:776]( /SoftwareEng/Lec/AllContent.txt#L776) - "Acceptance testing: Customers test whether the system is ready to be accepted and deployed...")*
4. **vulnerability**  
   *(Ref: [AllContent.txt:919]( /SoftwareEng/Lec/AllContent.txt#L919) - "Vulnerability: Weakness that may be exploited.")*
5. **data processor**  
   *(Ref: [AllContent.txt:1077-1079]( /SoftwareEng/Lec/AllContent.txt#L1077-1079) - "Data processor: Processes collected information and computes response.")*
...
*Award 1.5 marks for Risk Management comparison, 1.5 marks for Changing Requirements comparison, and 2 marks for Test Planning comparison. (Ref: [AllContent.txt:303-328]( /SoftwareEng/Lec/AllContent.txt#L303-328))*
...
*Award 2 marks for explaining why requirements are a compromise, and 3 marks for detailing the three change management steps. (Ref: [AllContent.txt:462-468]( /SoftwareEng/Lec/AllContent.txt#L462-468) & [L489-506]( /SoftwareEng/Lec/AllContent.txt#L489-506))*
...
*Award 1.25 marks for each of the four properties explained. (Ref: [AllContent.txt:965-975]( /SoftwareEng/Lec/AllContent.txt#L965-975))*
...
*Award 2.5 marks for objective comparison, and 2.5 marks for successful test comparison. (Ref: [AllContent.txt:602-617]( /SoftwareEng/Lec/AllContent.txt#L602-617))*
...
*Award 1.5 marks for each level's description, and 0.5 marks for identifying the software engineering level. (Ref: [AllContent.txt:884-888]( /SoftwareEng/Lec/AllContent.txt#L884-888))*
...
*Award marks for attacker (1 Mark), threat use cases (2 Marks), and mitigation links (2 Marks). (Ref: [AllContent.txt:920-944]( /SoftwareEng/Lec/AllContent.txt#L920-944))*
