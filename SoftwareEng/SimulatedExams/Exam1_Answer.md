...
1. **activities**  
   *(Ref: [AllContent.txt:L68](file:///d:/Gam3a/Exam-Creation/SoftwareEng/Lec/AllContent.txt#L68) - "Software process: a structured set of activities...")*
2. **agile**  
   *(Ref: [AllContent.txt:L76-77](file:///d:/Gam3a/Exam-Creation/SoftwareEng/Lec/AllContent.txt#L76-77) - "Plan-driven: Activities are planned in advance. Agile: Planning is incremental...")*
3. **software discovery**  
   *(Ref: [AllContent.txt:L166](file:///d:/Gam3a/Exam-Creation/SoftwareEng/Lec/AllContent.txt#L166) - "Software discovery and evaluation: Search for existing reusable systems...")*
4. **customers / end users**  
   *(Ref: [AllContent.txt:L430-432](file:///d:/Gam3a/Exam-Creation/SoftwareEng/Lec/AllContent.txt#L430-432) - "User requirements... Written for: Customers/end users.")*
5. **Change analysis and costing**  
   *(Ref: [AllContent.txt:L482-484](file:///d:/Gam3a/Exam-Creation/SoftwareEng/Lec/AllContent.txt#L482-484) - "1. Problem analysis and change specification -> 2. Change analysis and costing...")*
...
*Award 1.5 marks for each valid reason listed, up to a maximum of 5 marks. (Ref: [AllContent.txt:L246-249](file:///d:/Gam3a/Exam-Creation/SoftwareEng/Lec/AllContent.txt#L246-249))*
...
*Award 2 marks for the definition, and 3 marks for explaining why it is essential. (Ref: [AllContent.txt:L466-468](file:///d:/Gam3a/Exam-Creation/SoftwareEng/Lec/AllContent.txt#L466-468) & [L499-501](file:///d:/Gam3a/Exam-Creation/SoftwareEng/Lec/AllContent.txt#L499-501))*
...
*Award 1 mark for listing the stages, and 1.3 marks for explaining each stage. (Ref: [AllContent.txt:L283-287](file:///d:/Gam3a/Exam-Creation/SoftwareEng/Lec/AllContent.txt#L283-287))*
...
*Award up to 5 marks based on the completeness and clarity of the comparison table. (Ref: [AllContent.txt:L76-83](file:///d:/Gam3a/Exam-Creation/SoftwareEng/Lec/AllContent.txt#L76-83))*
...
*Award 2.5 marks for part (a) and 2.5 marks for part (b). (Ref: [AllContent.txt:L257-263](file:///d:/Gam3a/Exam-Creation/SoftwareEng/Lec/AllContent.txt#L257-263))*
...
*Award 2 marks for model name, and 1.5 marks for each justification. (Ref: [AllContent.txt:L112-120](file:///d:/Gam3a/Exam-Creation/SoftwareEng/Lec/AllContent.txt#L112-120), [L160-163](file:///d:/Gam3a/Exam-Creation/SoftwareEng/Lec/AllContent.txt#L160-163))*
...
*Award 1 mark for each stage listed with correct context. (Ref: [AllContent.txt:L164-171](file:///d:/Gam3a/Exam-Creation/SoftwareEng/Lec/AllContent.txt#L164-171))*
...
*Award 2.5 marks for a valid advantage and 2.5 marks for a valid disadvantage. (Ref: [AllContent.txt:L172-177](file:///d:/Gam3a/Exam-Creation/SoftwareEng/Lec/AllContent.txt#L172-177))*
