...
1. **absence**  
   *(Ref: [AllContent.txt:600]( /SoftwareEng/Lec/AllContent.txt#600) - "Testing can reveal the presence of errors, not their absence.")*
2. **validation**  
   *(Ref: [AllContent.txt:622-627]( /SoftwareEng/Lec/AllContent.txt#L622-627) - "Verification: Are we building the product right?... Validation: Are we building the right product?")*
3. **Assertion**  
   *(Ref: [AllContent.txt:701-706]( /SoftwareEng/Lec/AllContent.txt#L701-706) - "Setup... Call... Assertion...")*
4. **Availability**  
   *(Ref: [AllContent.txt:874-883]( /SoftwareEng/Lec/AllContent.txt#L874-883) - "Confidentiality, Integrity, Availability...")*
5. **confidentiality**  
   *(Ref: [AllContent.txt:875-877]( /SoftwareEng/Lec/AllContent.txt#L875-877) - "Confidentiality: Information must not be disclosed... Attacker reads patient records.")*
...
*Award up to 5 marks based on covering all three required comparison points. (Ref: [AllContent.txt:746-750]( /SoftwareEng/Lec/AllContent.txt#L746-750))*
...
*Award 2.5 marks for process explanation and 2.5 marks for three correct benefits. (Ref: [AllContent.txt:731-741]( /SoftwareEng/Lec/AllContent.txt#L731-741))*
* **TDD Process Cycle:**
...
*Award 2.5 marks for explaining the human/social aspect, and 2.5 marks for the balance discussion. (Ref: [AllContent.txt:888-898]( /SoftwareEng/Lec/AllContent.txt#L888-898))*
...
*Award up to 5 marks based on clarity and correctness of the comparison. (Ref: [AllContent.txt:641-655]( /SoftwareEng/Lec/AllContent.txt#L641-655))*
...
*Award 1.5 marks for each strategy's explanation and example, plus 0.5 bonus for formatting. (Ref: [AllContent.txt:949-963]( /SoftwareEng/Lec/AllContent.txt#L949-963))*
...
*Award 2.5 marks for the dimension, and 2.5 marks for the threat classification. (Ref: [AllContent.txt:878-881]( /SoftwareEng/Lec/AllContent.txt#L878-881) & [L933-937]( /SoftwareEng/Lec/AllContent.txt#L933-937))*
...
*Award 1.25 marks for each partition listed with its corresponding test values. (Ref: [AllContent.txt:710-715]( /SoftwareEng/Lec/AllContent.txt#L710-715))*
...
*Award 2 marks for the explanation, and 3 marks for the scenario description. (Ref: [AllContent.txt:754-756]( /SoftwareEng/Lec/AllContent.txt#L754-756))*
